...
<title>Destino | Actualizar</title>
...
<body>
	...
	<div class="container-fluid text-center p-2">
		...
		<section class="content"
			...
			<h1 class="text-center mb-5">Actualizar Destino</h1>

			<form:form action="actualizarDestino" modelAttribute="datosDestino"
				method="post"
				...
				<div class="row">
				   ...
				   <div class="mb-3">
						...
						<form:select path="tipoViaje.codigo" cssClass="form-select" >
							...
							<form:options items="${datosDestino.mapTipoViajes}"  />
		...
		<div class="row">
			...
			<p class="col-sm-6"> <a href="${context}/destino">Volver al menu Destino</a> </p>
		</div>
	</div>
