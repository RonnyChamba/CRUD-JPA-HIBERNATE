...
<c:set var="context"  value="<%=application.getContextPath() %>"/>
	...
	<div class="container-fluid text-center p-2">
		...
		<section class="content"
			...
			<form:form action="guardar" modelAttribute="nuevoCliente"
				method="post"
				...
				<div class="row">
					...
					<div class="mb-3 col-sm-6">
						...
						<form:select path="estadoCivil" cssClass="form-select">
							...
							<form:options items="${nuevoCliente.tiposEstados}" />
		...
		<div class="row">
			...
			<p class="col-sm-6"> <a href="${context}/cliente">Volver al menu Cliente</a> </p>
		</div>
	</div>
