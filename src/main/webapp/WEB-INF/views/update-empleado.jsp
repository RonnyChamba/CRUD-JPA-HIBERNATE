...
<title>Empleado | Actualizar</title>
...
<body>
	...
	<div class="container-fluid">
		...
		<section class="content"
			...
			<h1 class="text-center mb-5">Actualizar Empleado</h1>

			<form:form action="actualizarEmpleado" modelAttribute="datosEmpleado"
				method="post"
				...
				<div class="row">
					...
					<div class="mb-3 col-sm-6">
						...
						<form:select path="estadoCivil" cssClass="form-select">
							...
							<form:options items="${datosEmpleado.tiposEstados}" />
